...
Página em construção. Se você tiver alguma experiência com código, você pode dar uma olhada no [GitHub do projeto](https://github.com/TaylorHo/avalia). É relativamente simples de configurá-lo, especialmente utilizando a [Vercel](https://vercel.com/).
